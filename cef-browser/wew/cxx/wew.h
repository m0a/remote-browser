...
typedef enum
{
    WEW_JSDIALOG_ALERT = 0,
    WEW_JSDIALOG_CONFIRM = 1,
    WEW_JSDIALOG_PROMPT = 2,
    WEW_JSDIALOG_BEFOREUNLOAD = 3,
} JSDialogType;
...
typedef enum
{
    WEW_FILE_DIALOG_OPEN = 0,
    WEW_FILE_DIALOG_OPEN_MULTIPLE = 1,
    WEW_FILE_DIALOG_OPEN_FOLDER = 2,
    WEW_FILE_DIALOG_SAVE = 3,
} FileDialogMode;
