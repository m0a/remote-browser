...
class IWebViewJSDialog : public CefJSDialogHandler
{
  public:
    IWebViewJSDialog(WebViewHandler &handler);
  ...
  private:
    ...
    IMPLEMENT_REFCOUNTING(IWebViewJSDialog);
};

class IWebViewFileDialog : public CefDialogHandler
{
  public:
    IWebViewFileDialog(WebViewHandler &handler);
